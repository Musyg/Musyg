...
<picture>
  ...
  <source media="(prefers-color-scheme: dark) and (max-width: 1150px)" srcset="./assets/profile-header-tablet-dark.svg">
  <source media="(prefers-color-scheme: light) and (max-width: 1150px)" srcset="./assets/profile-header-tablet-light.svg">
